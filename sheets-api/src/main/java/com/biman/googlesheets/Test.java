...
public class Test {
    ...
    public static void main(String... args) throws IOException, GeneralSecurityException {
        ...
        InputStream inputStream = Test.class.getResourceAsStream("/credentials.json");
        if (inputStream == null){
            System.out.println("null stream");
        }
        GoogleCredentials credential = ServiceAccountCredentials.fromStream(inputStream)
...
//        for (Sheets.Spreadsheets spreadsheets sheetService.spreadsheets()
